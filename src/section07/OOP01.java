 ...
 * 
 * 예) 물리적인 객체 - 컴퓨터 ,휴대폰 ,학생 , 회원 등등 / 식별가능한 번호, 주소 부여됨.
 * 		추상적인 객체 - 주문정보 , 영수증 ,게임 유닛 , 회계 장부 등등  / '
 * 
 * 객체의 구성요소
 * 1) 속성 ->변수
 * 2) 기능 ->메서드 
 ...
 * 
 * 객체화 하는 방법 
 * -new 연산자로 인스턴트 화 가능! / 사용하면 같은 모양의 객체를 만들수 있음.
 * 클래스명 변수명 =new 클래스();
 * 
